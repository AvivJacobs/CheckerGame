...
namespace B18_Ex05
{
    public class DamkaForm : Form
    {
        ...
        public DamkaForm(Game i_DamkaGame)
        {
            ...
            this.BackgroundImage = Ex05.UI.Properties.Resources.whiteBackground;
        ...
        private void initializeComponent()
        {
            ...
            pieceOfCurrentPlayerPictureBox.Image = Ex05.UI.Properties.Resources.smallBlackSoldier;
        ...
        private void checkerButton_Click(object sender, EventArgs e)
        {
            ...
            if (m_FromChecker == null)
            {
                ...
                pressedChecker.BackgroundImage = Ex05.UI.Properties.Resources.whiteBlueBackgroundpng;
            ...
            {
                m_FromChecker = null;
                pressedChecker.BackgroundImage = Ex05.UI.Properties.Resources.whiteBackground;
            }
            else
            {
                ...
                checkerButtonMatrix[m_FromChecker.Row, m_FromChecker.Column].BackgroundImage = Ex05.UI.Properties.Resources.whiteBackground;
        ...
        // $G$ DSN-003 (-4) This method is too long. Should be split into several methods.
        // for example , the last part should be in a function called : checkGameStatus
        private bool manageTurn()
        {
            ...
            else
            {
                ...
                while (!isTurnOver)
                {
                    ...
                    {
                        if (m_CheckerGame.CheckerBoard.BoardMatrix[computerMove.FromChecker.Row, computerMove.FromChecker.Column].SignOfPieceInChecker != 'U' && m_CheckerGame.CheckerBoard.BoardMatrix[computerMove.FromChecker.Row, computerMove.FromChecker.Column].SignOfPieceInChecker != 'K')
                        {
                            playSound(Ex05.UI.Properties.Resources.KingSound);
                        }
                    }
                    else
                    {
                        playSound(Ex05.UI.Properties.Resources.woodKnockSound);
                    }
        ...
        private bool manageHumanTurn(BoardPosition i_FromChecker, BoardPosition i_ToChecker)
        {
            ...
            if (playerMove == null)
            {
                playSound(Ex05.UI.Properties.Resources.InvalidMoveSound);
            ...
            else
            {
                ...
                if (isMoveMakeMenAKing == true)
                {
                    ...
                    if (m_CheckerGame.CheckerBoard.BoardMatrix[m_FromChecker.Row, m_FromChecker.Column].SignOfPieceInChecker != 'U' && m_CheckerGame.CheckerBoard.BoardMatrix[m_FromChecker.Row, m_FromChecker.Column].SignOfPieceInChecker != 'K')
                    {
                        playSound(Ex05.UI.Properties.Resources.KingSound);
                    }
                }
        ...
        private void setCheckerInForm(int i_Row, int i_Coloumn)
        {
            ...
            {
                checkerButtonMatrix[i_Row, i_Coloumn].BackgroundImage = Ex05.UI.Properties.Resources.whiteBackground;
                if (m_CheckerGame.CheckerBoard.BoardMatrix[i_Row, i_Coloumn].SignOfPlayerInChecker == Checker.eSignOfPlayerInChecker.X)
                {
                    checkerButtonMatrix[i_Row, i_Coloumn].Image = Ex05.UI.Properties.Resources.whiteSoldier;
                }
                else if (m_CheckerGame.CheckerBoard.BoardMatrix[i_Row, i_Coloumn].SignOfPlayerInChecker == Checker.eSignOfPlayerInChecker.O)
                {
                    checkerButtonMatrix[i_Row, i_Coloumn].Image = Ex05.UI.Properties.Resources.blackSoldier2;
                }
                else
                {
            ...
            {
                checkerButtonMatrix[i_Row, i_Coloumn].BackgroundImage = Ex05.UI.Properties.Resources.blackCheckerBackground;
        ...
        private void updateFormAtEndOfMove(BoardPosition i_PositionOfEatenPiece)
        {
            if ((m_ToChecker.Row == 0) || (m_ToChecker.Row == (int)m_CheckerGame.CheckerBoard.BoardSize - 1))
            {
                ...
                {
                    checkerButtonMatrix[m_ToChecker.Row, m_ToChecker.Column].Image = Ex05.UI.Properties.Resources.BlackCrown;
                }
                else
                {
                    checkerButtonMatrix[m_ToChecker.Row, m_ToChecker.Column].Image = Ex05.UI.Properties.Resources.WhiteCrown;
                }
            }
            else
            {
        ...
        private void setPlayerTurnLabel()
        {
            ...
            {
                pieceOfCurrentPlayerPictureBox.Image = Ex05.UI.Properties.Resources.smallWhiteSoldier;
            }
